...
The cloudbuild.yaml pipeline builds and tests the application, pushes an image tagged with the build ID to Artifact Registry, and deploys Cloud Run. The main branch is the production branch.
